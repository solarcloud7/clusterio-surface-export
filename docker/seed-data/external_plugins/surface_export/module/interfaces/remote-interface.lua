...
local clone_platform = Base.debug_wrap("clone_platform", require("modules/surface_export/interfaces/remote/clone-platform"))
local version_selftest = Base.debug_wrap("version_selftest", require("modules/surface_export/interfaces/remote/version-selftest"))
local timing_selftest = Base.debug_wrap("timing_selftest", require("modules/surface_export/interfaces/remote/timing-selftest"))
local selection_lab_drive = Base.debug_wrap("selection_lab_drive", require("modules/surface_export/interfaces/remote/selection-lab-drive"))
local belt_side_restore_selftest = Base.debug_wrap("belt_side_restore_selftest", require("modules/surface_export/interfaces/remote/belt-side-restore-selftest"))
local inventory_import_guard_selftest = Base.debug_wrap("inventory_import_guard_selftest", require("modules/surface_export/interfaces/remote/inventory-import-guard-selftest"))
local gateway_selftest = Base.debug_wrap("gateway_selftest", require("modules/surface_export/interfaces/remote/gateway-selftest"))
local schedule_selftest = Base.debug_wrap("schedule_selftest", require("modules/surface_export/interfaces/remote/schedule-selftest"))
local transfer_lock_selftest = Base.debug_wrap("transfer_lock_selftest", require("modules/surface_export/interfaces/remote/transfer-lock-selftest"))
local no_tick_sync_selftest = Base.debug_wrap("no_tick_sync_selftest", require("modules/surface_export/interfaces/remote/no-tick-sync-selftest"))
local fluid_segment_law_selftest = Base.debug_wrap("fluid_segment_law_selftest", require("modules/surface_export/interfaces/remote/fluid-segment-law-selftest"))
local pole_copper_prune_selftest = Base.debug_wrap("pole_copper_prune_selftest", require("modules/surface_export/interfaces/remote/pole-copper-prune-selftest"))
local hold_aware_unlock_selftest = Base.debug_wrap("hold_aware_unlock_selftest", require("modules/surface_export/interfaces/remote/hold-aware-unlock-selftest"))
local export_cache_selftest = Base.debug_wrap("export_cache_selftest", require("modules/surface_export/interfaces/remote/export-cache-selftest"))
local blueprint_diff_selftest = Base.debug_wrap("blueprint_diff_selftest", require("modules/surface_export/interfaces/remote/blueprint-diff-selftest"))
local import_target_selftest = Base.debug_wrap("import_target_selftest", require("modules/surface_export/interfaces/remote/import-target-selftest"))
local signal_stability_selftest = Base.debug_wrap("signal_stability_selftest", require("modules/surface_export/interfaces/remote/signal-stability-selftest"))
local latch_rearm_params_selftest = Base.debug_wrap("latch_rearm_params_selftest", require("modules/surface_export/interfaces/remote/latch-rearm-params-selftest"))
local configure_gateways_remote = require("modules/surface_export/interfaces/remote/configure-gateways")
local gateway_config_staging_selftest = Base.debug_wrap("gateway_config_staging_selftest", require("modules/surface_export/interfaces/remote/gateway-config-staging-selftest"))
...
for _, name in ipairs({"set_test_roster", "set_test_roster_begin", "set_test_roster_chunk", "set_test_roster_commit"}) do
  test_roster[name] = Base.debug_wrap(name, test_roster[name])
end
for _, name in ipairs({"lifecycle_setup", "lifecycle_dest_setup", "lifecycle_verify", "lifecycle_teardown"}) do
  lifecycle[name] = Base.debug_wrap(name, lifecycle[name])
end
