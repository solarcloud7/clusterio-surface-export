local ConnectionRestoration = require("modules/surface_export/import_phases/connection_restoration")
...
Deserializer.restore_circuit_connections = ConnectionRestoration.restore_circuit_connections
