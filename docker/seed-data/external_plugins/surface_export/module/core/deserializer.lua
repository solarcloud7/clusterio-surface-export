...
local SIMPLE_RESTORE_RULES = {
  ...
  { field = "pickup_from_left_lane", present = true, types = { ["inserter"] = true } },
  { field = "pickup_from_right_lane", present = true, types = { ["inserter"] = true } },
  { field = "loader_filter_mode", types = { ["loader"] = true, ["loader-1x1"] = true } },
