...
function InventoryScanner.export_string_keeps_identity(scratch, name, quality, count, export_string)
  ...
  local wanted_quality = quality or Util.QUALITY_NORMAL
  ...
  if not import_ok then
    Util.pcall_warn("[InventoryScanner] scratch clear", function() slot.clear() end)
  ...
  if slot.valid_for_read then
    local seen_quality = (slot.quality and slot.quality.name) or Util.QUALITY_NORMAL
