...
class PlatformTree {
    ...
    async requestInstancePlatforms(instanceId, forceName = "player") {
        try {
            const response = await this.plugin.controller.sendTo({ instanceId }, new this.messages.InstanceListPlatformsRequest({ forceName }));
            return {
            ...
            return {
                platforms: [],
                error: (0, helpers_1.getErrorMessage)(err),
            };
        }
    }
...
//# sourceMappingURL=platform-tree.js.map