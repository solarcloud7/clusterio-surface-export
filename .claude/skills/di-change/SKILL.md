...
node tools/run-integration-tests.mjs --only 'pad-transfer-suite'   # the sabotage teeth + census witnesses are pad fixtures (gate-item-loss, gate-fluid-loss, rollback-validation-failure, failed-entity-attribution, force-bonus-held)
```
