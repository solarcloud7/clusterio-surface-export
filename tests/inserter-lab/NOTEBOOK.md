...
## 2026-07-19T00:15:20.898Z — B7 held-item capacity batch (bake gate, GREEN)

Runner: `tests/lab-gallery/run-golden-batch.mjs` against the committed golden pair loaded via Clusterio-native save assignment (instances {"1":2119131471,"2":234487481}); pre-batch saves {"1":"test1.zip","2":"test2.zip"}, restored {"1":"test1.zip","2":"test2.zip","zeroLeftovers":true}.

**Adversarial dest** — loaded golden destination bulk_inserter_capacity_bonus = 0 (asserted 0, never forced). **Source fingerprint** reproduced from the save-loaded world: bulk-inserter at (98.5,13.5) held 8 railgun-ammo (legendary), inactive+indestructible, source force bonus 11.

**Transfer** — production `/transfer-platform 16` reached terminal validation_success=true (/clusterio/data/instances/clusterio-host-2-instance-1/script-output/debug_import_result_lab-omnibus-state-v1_9267464.json). INDEPENDENT physical destination reads: force bonus RAISED 0 -> 11 (raise-only), hand physically seats 8 railgun-ammo at legendary, forceDataMismatches recorded ({"force":"player","property":"bulk_inserter_capacity_bonus","source":11,"destination":0,"synced_to":11}), source deleted. GREEN.
...
```json
{
  ...
  "importResultPath": "/clusterio/data/instances/clusterio-host-2-instance-1/script-output/debug_import_result_lab-omnibus-state-v1_9267464.json",
  "destBonusAfter": 11,
  "destInserter": {
    "success": true,
    "platformIndex": 19,
...
## 2026-07-19T00:16:14.189Z — B7 held-item capacity batch (bake gate, GREEN)

Runner: `tests/lab-gallery/run-golden-batch.mjs` against the committed golden pair loaded via Clusterio-native save assignment (instances {"1":2119131471,"2":234487481}); pre-batch saves {"1":"test1.zip","2":"test2.zip"}, restored {"1":"test1.zip","2":"test2.zip","zeroLeftovers":true}.

**Adversarial dest** — loaded golden destination bulk_inserter_capacity_bonus = 0 (asserted 0, never forced). **Source fingerprint** reproduced from the save-loaded world: bulk-inserter at (98.5,13.5) held 8 railgun-ammo (legendary), inactive+indestructible, source force bonus 11.

**Transfer** — production `/transfer-platform 16` reached terminal validation_success=true (/clusterio/data/instances/clusterio-host-2-instance-1/script-output/debug_import_result_lab-omnibus-state-v1_9267451.json). INDEPENDENT physical destination reads: force bonus RAISED 0 -> 11 (raise-only), hand physically seats 8 railgun-ammo at legendary, forceDataMismatches recorded ({"force":"player","property":"bulk_inserter_capacity_bonus","source":11,"destination":0,"synced_to":11}), source deleted. GREEN.
...
```json
{
  ...
  "importResultPath": "/clusterio/data/instances/clusterio-host-2-instance-1/script-output/debug_import_result_lab-omnibus-state-v1_9267451.json",
  "destBonusAfter": 11,
  "destInserter": {
    "success": true,
    "platformIndex": 19,
...
## 2026-07-19T02:14:11.859Z — B7 held-item capacity batch (bake gate, GREEN)

Runner: `tests/lab-gallery/run-golden-batch.mjs` against the committed golden pair loaded via Clusterio-native save assignment (instances {"1":2119131471,"2":234487481}); pre-batch saves {"1":"test1.zip","2":"test2.zip"}, restored {"1":"test1.zip","2":"test2.zip","zeroLeftovers":true}.

**Adversarial dest** — loaded golden destination bulk_inserter_capacity_bonus = 0 (asserted 0, never forced). **Source fingerprint** reproduced from the save-loaded world: bulk-inserter at (98.5,13.5) held 8 railgun-ammo (legendary), inactive+indestructible, source force bonus 11.

**Transfer** — production `/transfer-platform 16` reached terminal validation_success=true (/clusterio/data/instances/clusterio-host-2-instance-1/script-output/debug_import_result_lab-omnibus-state-v1_9267390.json). INDEPENDENT physical destination reads: force bonus RAISED 0 -> 11 (raise-only), hand physically seats 8 railgun-ammo at legendary, forceDataMismatches recorded ({"force":"player","property":"bulk_inserter_capacity_bonus","source":11,"destination":0,"synced_to":11}), source deleted. GREEN.
...
```json
{
  ...
  "importResultPath": "/clusterio/data/instances/clusterio-host-2-instance-1/script-output/debug_import_result_lab-omnibus-state-v1_9267390.json",
  "destBonusAfter": 11,
  "destInserter": {
    "success": true,
    "platformIndex": 19,
...
## 2026-07-19T02:28:34.967Z — B7 held-item capacity batch (bake gate, GREEN)

Runner: `tests/lab-gallery/run-golden-batch.mjs` against the committed golden pair loaded via Clusterio-native save assignment (instances {"1":2119131471,"2":234487481}); pre-batch saves {"1":"test1.zip","2":"test2.zip"}, restored {"1":"test1.zip","2":"test2.zip","zeroLeftovers":true}.

**Adversarial dest** — loaded golden destination bulk_inserter_capacity_bonus = 0 (asserted 0, never forced). **Source fingerprint** reproduced from the save-loaded world: bulk-inserter at (98.5,13.5) held 8 railgun-ammo (legendary), inactive+indestructible, source force bonus 11.

**Transfer** — production `/transfer-platform 16` reached terminal validation_success=true (/clusterio/data/instances/clusterio-host-2-instance-1/script-output/debug_import_result_lab-omnibus-state-v1_9267477.json). INDEPENDENT physical destination reads: force bonus RAISED 0 -> 11 (raise-only), hand physically seats 8 railgun-ammo at legendary, forceDataMismatches recorded ({"force":"player","property":"bulk_inserter_capacity_bonus","source":11,"destination":0,"synced_to":11}), source deleted. GREEN.
...
```json
{
  ...
  "importResultPath": "/clusterio/data/instances/clusterio-host-2-instance-1/script-output/debug_import_result_lab-omnibus-state-v1_9267477.json",
  "destBonusAfter": 11,
  "destInserter": {
    "success": true,
    "platformIndex": 19,
...
## 2026-07-19T02:30:49.342Z — B7 held-item capacity batch (bake gate, GREEN)

Runner: `tests/lab-gallery/run-golden-batch.mjs` against the committed golden pair loaded via Clusterio-native save assignment (instances {"1":2119131471,"2":234487481}); pre-batch saves {"1":"test1.zip","2":"test2.zip"}, restored {"1":"test1.zip","2":"test2.zip","zeroLeftovers":true}.

**Adversarial dest** — loaded golden destination bulk_inserter_capacity_bonus = 0 (asserted 0, never forced). **Source fingerprint** reproduced from the save-loaded world: bulk-inserter at (98.5,13.5) held 8 railgun-ammo (legendary), inactive+indestructible, source force bonus 11.

**Transfer** — production `/transfer-platform 16` reached terminal validation_success=true (/clusterio/data/instances/clusterio-host-2-instance-1/script-output/debug_import_result_lab-omnibus-state-v1_9267736.json). INDEPENDENT physical destination reads: force bonus RAISED 0 -> 11 (raise-only), hand physically seats 8 railgun-ammo at legendary, forceDataMismatches recorded ({"force":"player","property":"bulk_inserter_capacity_bonus","source":11,"destination":0,"synced_to":11}), source deleted. GREEN.
...
```json
{
  ...
  "importResultPath": "/clusterio/data/instances/clusterio-host-2-instance-1/script-output/debug_import_result_lab-omnibus-state-v1_9267736.json",
  "destBonusAfter": 11,
  "destInserter": {
    "success": true,
    "platformIndex": 19,
...
## 2026-07-19T02:45:05.321Z — B7 held-item capacity batch (bake gate, GREEN)

Runner: `tests/lab-gallery/run-golden-batch.mjs` against the committed golden pair loaded via Clusterio-native save assignment (instances {"1":2119131471,"2":234487481}); pre-batch saves {"1":"test1.zip","2":"test2.zip"}, restored {"1":"test1.zip","2":"test2.zip","zeroLeftovers":true}.

**Adversarial dest** — loaded golden destination bulk_inserter_capacity_bonus = 0 (asserted 0, never forced). **Source fingerprint** reproduced from the save-loaded world: bulk-inserter at (98.5,13.5) held 8 railgun-ammo (legendary), inactive+indestructible, source force bonus 11.

**Transfer** — production `/transfer-platform 16` reached terminal validation_success=true (/clusterio/data/instances/clusterio-host-2-instance-1/script-output/debug_import_result_lab-omnibus-state-v1_9268033.json). INDEPENDENT physical destination reads: force bonus RAISED 0 -> 11 (raise-only), hand physically seats 8 railgun-ammo at legendary, forceDataMismatches recorded ({"force":"player","property":"bulk_inserter_capacity_bonus","source":11,"destination":0,"synced_to":11}), source deleted. GREEN.
...
```json
{
  ...
  "importResultPath": "/clusterio/data/instances/clusterio-host-2-instance-1/script-output/debug_import_result_lab-omnibus-state-v1_9268033.json",
  "destBonusAfter": 11,
  "destInserter": {
    "success": true,
    "platformIndex": 19,
...
## 2026-07-19T02:46:36.964Z — B7 held-item capacity batch (bake gate, GREEN)

Runner: `tests/lab-gallery/run-golden-batch.mjs` against the committed golden pair loaded via Clusterio-native save assignment (instances {"1":2119131471,"2":234487481}); pre-batch saves {"1":"test1.zip","2":"test2.zip"}, restored {"1":"test1.zip","2":"test2.zip","zeroLeftovers":true}.

**Adversarial dest** — loaded golden destination bulk_inserter_capacity_bonus = 0 (asserted 0, never forced). **Source fingerprint** reproduced from the save-loaded world: bulk-inserter at (98.5,13.5) held 8 railgun-ammo (legendary), inactive+indestructible, source force bonus 11.

**Transfer** — production `/transfer-platform 16` reached terminal validation_success=true (/clusterio/data/instances/clusterio-host-2-instance-1/script-output/debug_import_result_lab-omnibus-state-v1_9268040.json). INDEPENDENT physical destination reads: force bonus RAISED 0 -> 11 (raise-only), hand physically seats 8 railgun-ammo at legendary, forceDataMismatches recorded ({"force":"player","property":"bulk_inserter_capacity_bonus","source":11,"destination":0,"synced_to":11}), source deleted. GREEN.
...
```json
{
  ...
  "importResultPath": "/clusterio/data/instances/clusterio-host-2-instance-1/script-output/debug_import_result_lab-omnibus-state-v1_9268040.json",
  "destBonusAfter": 11,
  "destInserter": {
    "success": true,
    "platformIndex": 19,
...
## 2026-07-19T05:11:06.868Z — B7 held-item capacity batch (bake gate, GREEN)

Runner: `tests/lab-gallery/run-golden-batch.mjs` against the committed golden pair loaded via Clusterio-native save assignment (instances {"1":2119131471,"2":234487481}); pre-batch saves {"1":"test1.zip","2":"test2.zip"}, restored {"1":"test1.zip","2":"test2.zip","zeroLeftovers":true}.

**Adversarial dest** — loaded golden destination bulk_inserter_capacity_bonus = 0 (asserted 0, never forced). **Source fingerprint** reproduced from the save-loaded world: bulk-inserter at (98.5,13.5) held 8 railgun-ammo (legendary), inactive+indestructible, source force bonus 11.

**Transfer** — production `/transfer-platform 16` reached terminal validation_success=true (/clusterio/data/instances/clusterio-host-2-instance-1/script-output/debug_import_result_lab-omnibus-state-v1_9267405.json). INDEPENDENT physical destination reads: force bonus RAISED 0 -> 11 (raise-only), hand physically seats 8 railgun-ammo at legendary, forceDataMismatches recorded ({"force":"player","property":"bulk_inserter_capacity_bonus","source":11,"destination":0,"synced_to":11}), source deleted. GREEN.
...
```json
{
  ...
  "finished": "2026-07-19T05:11:06.868Z",
  "green": true,
  "errors": [],
  "destBonusBefore": 0,
  "sourceFingerprint": {
  ...
  "importResultPath": "/clusterio/data/instances/clusterio-host-2-instance-1/script-output/debug_import_result_lab-omnibus-state-v1_9267405.json",
  "destBonusAfter": 11,
  "destInserter": {
    "success": true,
    "platformIndex": 19,
...
## 2026-07-19T05:11:51.611Z — B7 held-item capacity batch (bake gate, GREEN)

Runner: `tests/lab-gallery/run-golden-batch.mjs` against the committed golden pair loaded via Clusterio-native save assignment (instances {"1":2119131471,"2":234487481}); pre-batch saves {"1":"test1.zip","2":"test2.zip"}, restored {"1":"test1.zip","2":"test2.zip","zeroLeftovers":true}.

**Adversarial dest** — loaded golden destination bulk_inserter_capacity_bonus = 0 (asserted 0, never forced). **Source fingerprint** reproduced from the save-loaded world: bulk-inserter at (98.5,13.5) held 8 railgun-ammo (legendary), inactive+indestructible, source force bonus 11.

**Transfer** — production `/transfer-platform 16` reached terminal validation_success=true (/clusterio/data/instances/clusterio-host-2-instance-1/script-output/debug_import_result_lab-omnibus-state-v1_9267407.json). INDEPENDENT physical destination reads: force bonus RAISED 0 -> 11 (raise-only), hand physically seats 8 railgun-ammo at legendary, forceDataMismatches recorded ({"force":"player","property":"bulk_inserter_capacity_bonus","source":11,"destination":0,"synced_to":11}), source deleted. GREEN.
...
```json
{
  ...
  "finished": "2026-07-19T05:11:51.611Z",
  "green": true,
  "errors": [],
  "destBonusBefore": 0,
  "sourceFingerprint": {
  ...
  "importResultPath": "/clusterio/data/instances/clusterio-host-2-instance-1/script-output/debug_import_result_lab-omnibus-state-v1_9267407.json",
  "destBonusAfter": 11,
  "destInserter": {
    "success": true,
    "platformIndex": 19,
