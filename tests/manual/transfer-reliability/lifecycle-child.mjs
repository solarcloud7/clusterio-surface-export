// Child-process probe: execute the actual upload runner with a waiting setup surrogate.
// No Docker commands or game changes; the parent sends a real OS signal on POSIX.
