...
function completeSchema() {
	return {
		...
		classes: [
			...
			apiClass("LuaSurface", ["create_entity", "find_entity", "set_tiles", "delete_chunk", "get_property", "find_non_colliding_position", "can_place_entity", "find_entities_filtered"], ["platform", "planet", "map_gen_settings"]),
