...
| Source gone without a deletion receipt | If a departed passenger's platform has been gone for 10 seconds and no deletion receipt exists, the destination can never go live for that transfer. The passenger is returned to the landing pad and given their carried gear back, as in a failed transfer. |
